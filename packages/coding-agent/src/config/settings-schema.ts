...
export const SETTINGS_SCHEMA = {
	...
	animations: {
		...
		ui: {
			...
			description:
				"Motion tier for ambient animated widgets (e.g. the tool constellation star map). off: static text; subtle: reduced cadence; full: smooth. Always forced off outside a TTY or under NO_COLOR/CI/dumb terminals.",
			options: [
