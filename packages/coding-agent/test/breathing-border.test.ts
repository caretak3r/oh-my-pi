...
import {
	...
	pulsePosition,
} from "@oh-my-pi/pi-coding-agent/breathing-border/breath";
import {
	type BreathingBorderContext,
	BreathingBorderController,
} from "@oh-my-pi/pi-coding-agent/breathing-border/controller";
import { BreathingBorderState } from "@oh-my-pi/pi-coding-agent/breathing-border/state";
import {
	...
	STATIC_BORDER_WIDTH,
} from "@oh-my-pi/pi-coding-agent/breathing-border/widget";
